...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header"><h4>{{ __('Add Employee') }}</h4></div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('employees.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input id="phone" type="text" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="phone" value="{{ old('phone') }}" placeholder="+380 (__) ___ __ __"  required autofocus>
...
{{--                                    <input id="position" type="text" class="form-control{{ $errors->has('position') ? ' is-invalid' : '' }}" name="position" value="{{ old('position') }}" required autofocus>--}}
                            ...
                            <div class="form-group">
                                <label for="head" class="col-md-4 ml-auto">{{ __('Head') }}</label>
                                    ...
                                    <div class="col-md-12">
                                        <input id="head" type="text" class="form-control{{ $errors->has('head') ? ' is-invalid' : '' }}" name="head" value="{{ old('head') }}" required autofocus>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input id="date_of_employment" type="text" class="form-control{{ $errors->has('date_of_employment') ? ' is-invalid' : '' }}" data-mask="00.00.00" name="date_of_employment" value="{{ old('date_of_employment') }}" required autofocus>
